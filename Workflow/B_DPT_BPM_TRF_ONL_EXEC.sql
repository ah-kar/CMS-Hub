...
/****** Object:  Job [B_DPT_BPM_TRF_ONL_EXEC]    Script Date: 6/25/2025 5:28:50 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Data Collector]    Script Date: 6/25/2025 5:28:50 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'B_DPT_BPM_TRF_ONL_EXEC', 
		@enabled=1, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Bill Payment Online Transaction', 
		@category_name=N'Data Collector', 
		@owner_login_name=N'CMSDB1\Administrator', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [J_ADD_TRF_INFO_EXEC]    Script Date: 6/25/2025 5:28:50 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'J_ADD_TRF_INFO_EXEC', 
		@step_id=1, 
...
END;', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [J_UPD_TRF_INFO_EXEC]    Script Date: 6/25/2025 5:28:50 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'J_UPD_TRF_INFO_EXEC', 
		@step_id=2, 
		@cmdexec_success_code=0, 
		@on_success_action=3, 
		@on_success_step_id=0, 
...
WHERE 
    ...
    AND ISONLINETRN = ''Y'' AND USRID = ''digital01''

COMMIT TRAN;', 
		@database_name=N'master', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [J_UPD_TRF_STS_EXEC]    Script Date: 6/25/2025 5:28:50 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'J_UPD_TRF_STS_EXEC', 
		@step_id=3, 
		@cmdexec_success_code=0, 
		@on_success_action=3, 
		@on_success_step_id=0, 
...
WHERE 
    STS IS NULL
    AND TRANCODE = ''DPT_BPM_TRF''
    AND ISONLINETRN = ''Y'' AND MERCHANTID = ''-''

COMMIT TRAN;', 
		@database_name=N'master', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [J_UPD_TRF_AMT_EXEC]    Script Date: 6/25/2025 5:28:50 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'J_UPD_TRF_AMT_EXEC', 
		@step_id=4, 
		@cmdexec_success_code=0, 
		@on_success_action=3, 
		@on_success_step_id=0, 
...
COMMIT TRAN;', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [J_ADD_OTP_OUT_LOG_EXEC]    Script Date: 6/25/2025 5:28:50 PM ******/
...
GO', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [J_ADD_SMS_OUT_LOG_EXEC]    Script Date: 6/25/2025 5:28:50 PM ******/
...
COMMIT TRAN;', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [J_ADD_MAIL_OUT_LOG_EXEC]    Script Date: 6/25/2025 5:28:50 PM ******/
...
COMMIT TRAN;', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [J_UPD_TRN_LOG_BODY_EXEC]    Script Date: 6/25/2025 5:28:50 PM ******/
...
WHERE 
    ...
    AND TRANCODE = ''DPT_BPM_TRF''
    AND ISONLINETRN = ''Y''
    AND STS = ''C'' AND MERCHANTID = ''-''

COMMIT TRAN;', 
		@database_name=N'master', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [J_UPD_BILL_INFO_STS_EXEC]    Script Date: 6/25/2025 5:28:50 PM ******/
...
COMMIT TRAN;', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [J_ADD_WFE_LOG_EXEC]    Script Date: 6/25/2025 5:28:50 PM ******/
...
SELECT RECID
FROM D_HUBSTM WHERE CHAR45 IS NULL AND TRANCODE = ''DPT_BPM_TRF'' AND ISONLINETRN = ''Y'' AND MERCHANTID = ''-''
...
BEGIN
    ...
    SELECT 
        (SELECT *
         FROM D_HUBSTM
         WHERE RECID = @ID AND CHAR45 IS NULL AND TRANCODE = ''DPT_BPM_TRF'' AND ISONLINETRN = ''Y'' AND MERCHANTID = ''-''
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'B_DPT_BPM_TRF_ONL_EXEC', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=4, 
		...
		@schedule_uid=N'53d60715-1235-4f14-b7aa-3f913834579b'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
